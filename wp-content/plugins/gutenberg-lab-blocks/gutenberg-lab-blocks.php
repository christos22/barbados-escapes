...
require_once __DIR__ . '/includes/villa-subpages.php';
...
function gutenberg_lab_blocks_register_rewrite_content_types() {
	...
	gutenberg_lab_blocks_register_villa_subpage_rewrite();
}
...
function gutenberg_lab_blocks_register_blocks() {
	...
	register_block_type( __DIR__ . '/build/testimonial-carousel-slide' );
