...
const TABINDEX_DATA_KEY = 'editorialFeatureTabindex';
...
function initializeEditorialFeatureSlider( slider ) {
	const track = slider.querySelector( '[data-editorial-feature-track]' );
	const slides = Array.from( track?.children ?? [] );
	const previousButton = slider.querySelector( '[data-editorial-feature-prev]' );
	const nextButton = slider.querySelector( '[data-editorial-feature-next]' );
...
window.addEventListener( 'DOMContentLoaded', () => {
	document
		.querySelectorAll( '[data-editorial-feature-slider]' )
		.forEach( initializeEditorialFeatureSlider );
} );
