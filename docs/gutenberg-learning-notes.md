...
- Background image opacity is a block-specific behavior, so a small Inspector range control can store the percent while PHP turns it into a sanitized CSS custom property.
